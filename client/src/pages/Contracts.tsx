...
async function generateContractPDF(contract: ContractData) {
  ...
  const clauses = [
    ...
    { title: "SEGUNDA. COMISIÓN", text: `El Cliente acepta una comisión del ${contract.commissionRate}% + IVA sobre cada transacción procesada a través de la plataforma. Esta comisión incluye el procesamiento del pago, la gestión de disputas y el soporte técnico.` },
    { title: "TERCERA. COMISIÓN NO REEMBOLSABLE", text: "Las comisiones de procesamiento cobradas por KobraPay son definitivas e irrevocables. En caso de reembolso total o parcial a un cliente final, la comisión de procesamiento ya cobrada no será devuelta al Cliente. El Cliente es responsable de cubrir el monto total del reembolso a su cliente final con sus propios fondos. Esta política es estándar en la industria de procesamiento de pagos y aplica sin excepción, independientemente del motivo del reembolso." },
