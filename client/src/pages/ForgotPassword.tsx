  ...
  if (sent) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="shadow-lg border border-border w-full max-w-md text-center">
          <CardContent className="pt-10 pb-8">
            <CheckCircle className="w-16 h-16 text-emerald-500 mx-auto mb-4" />
            <h2 className="text-foreground text-xl font-bold mb-2">Correo enviado</h2>
            <p className="text-muted-foreground text-sm mb-2">
              Si el correo <strong className="text-foreground">{email}</strong> está registrado con contraseña, recibirás instrucciones para restablecerla.
            </p>
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg border border-border">
          <CardHeader className="pb-4">
            <CardTitle className="text-foreground text-xl">Recuperar contraseña</CardTitle>
